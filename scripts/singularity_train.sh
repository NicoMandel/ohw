...
# bind order for directories is important
singularity exec --bind --pwd /home/ubuntu "$basedir/appsource/local/hawkweed_drone/ohw/scripts":/home/ubuntu/ \
        ...
        "$basedir/scratch_lustre/yolo-rawpy.simg" python3 train_model.py s datasets/1cm/1cm.yaml 