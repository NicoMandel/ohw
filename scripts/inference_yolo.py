...
def save_prediction(input_dir : str, output : str, model_p : str, summary : bool):
    ...
    outdir_p = os.path.abspath(os.path.join(output, model_name))
...
if __name__=="__main__":
    ...
    if args.recursive:
        ...
        for site in site_dirs:
            save_prediction(str(site), args.output, args.model, args.label)
    else:
        save_prediction(args.input, args.output, args.model, args.label)