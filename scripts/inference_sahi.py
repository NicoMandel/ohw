...
def parse_args():
    ...
    parser.add_argument("--pixel", default=160, type=int, help="Minimum bounding box pixels per dimenions around object. Defaults to 160")
...
def sahi(input_dir : str, registry_f : str, resolution : str, output : str, name : str, summary : bool, visualise : bool, metric : str, confidence : float = None, overlap : float = 0.3, model_size : int = 1280, debug : bool = False,
    ...
    model_prfx = os.path.dirname(registry_f) if registry_f.endswith(".xlsx") else os.path.dirname(os.path.dirname(registry_f))
